...
public abstract class NoPathBaseController<DTO extends BaseEntity, ENTITY extends BaseEntity, ID> {

	private Logger logger = LoggerFactory.getLogger(NoPathBaseController.class);
	...
	public NoPathBaseController(BaseRepository<ENTITY, ID> repo, Class<DTO> dtoType, Class<ENTITY> entityType) {
		this.repo = repo;
